...
/* 
        ...
        // Implemented Double-Checking Lock and called the same threads
        Runnable task = () -> {
            SingletonClass instance = SingletonClass.getInstance();
            System.out.println("Address of instance from " + Thread.currentThread().getName() + ": " + instance);
        ...
        OUTPUT:
        Address of instance from Thread-0: design_principles.singleton.SingletonClass@516e4c6e
        Address of instance from Thread-4: design_principles.singleton.SingletonClass@516e4c6e
        Address of instance from Thread-2: design_principles.singleton.SingletonClass@516e4c6e
        Address of instance from Thread-3: design_principles.singleton.SingletonClass@516e4c6e
        Address of instance from Thread-1: design_principles.singleton.SingletonClass@516e4c6e
 */   
